...
const Home: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Học sinh có thể thực hiện các thí nghiệm tại nhà với thiết bị VR, không bị giới hạn bởi phòng thí nghiệm trường học.',
      color: 'purple'
    },
    {
      icon: communityIcon,
      title: 'Cộng Đồng Học Tập',
      description: 'Tham gia cộng đồng học sinh yêu khoa học, chia sẻ kết quả thí nghiệm và học hỏi từ bạn bè.',
      color: 'teal'
    },
    {
      icon: cupIcon,
    ...
    <MainLayout>
          ...
          <div className="container hero-container">
            ...
            <div className="hero-image animate-on-scroll">
              <div className="hero-image-wrapper">
                <img src={heroImage} alt="Học sinh đang trải nghiệm thực tế ảo" className="floating" />
      ...
      <section className="trusted-by">
        <div className="container">
          <h3 className="trusted-by-title animate-on-scroll">Được tin dùng bởi các trường học hàng đầu</h3>
          ...
          <div className="container">
            ...
            <div className="why-us-container">
              {features.map((feature, index) => (
                ...
                >
                  <div className={`feature-icon-bg feature-${feature.color}`}>
                    <img src={feature.icon} alt={feature.title} className="feature-icon-modern" />
                  </div>
              ...
              <div className="why-us-image-container animate-on-scroll">
                <img src={whyUsImage} alt="Học sinh đang sử dụng kính VR" className="why-us-image floating-slow" />
          ...
          {subjects.map((subject, index) => (
            <div key={subject.id} className={`subject-card animate-on-scroll ${index % 2 === 1 ? 'reverse' : ''}`} style={{animationDelay: `${index * 0.2}s`}}>
              <div className="subject-image">
                <img src={subject.image} alt={`Thí nghiệm ${subject.name}`} />
          ...
          <div className="courses-grid">
            ...
            <div className="course-card animate-on-scroll">
              <div className="course-image">
                <img src={course1Image} alt="Thí nghiệm phản ứng hạt nhân" />
            ...
            <div className="course-card animate-on-scroll" style={{animationDelay: '0.2s'}}>
              <div className="course-image">
                <img src={course2Image} alt="Phẫu thuật ảo cơ thể người" />
            ...
            <div className="course-card animate-on-scroll" style={{animationDelay: '0.4s'}}>
              <div className="course-image">
                <img src={course3Image} alt="Thí nghiệm hóa học" />
                <div className="course-badge">Phổ biến</div>
              </div>
              <div className="course-content">
      ...
      <section className="grade-levels">
        <div className="container">
          <div className="section-header animate-on-scroll">
            <h2>Dành Cho <span className="gradient-text">Mọi Cấp Học</span></h2>
